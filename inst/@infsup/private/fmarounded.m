...
## usage:  fmarounded (X, Y, Z, DIRECTION)
##
## Fused multiply and add (X * Y) + Z.
##
## The result will be correctly rounded up or down according to DIRECTION
## (possible values: inf or -inf).
##
## Example:
##  x = 2;
##  y = 3;
##  z = 1;
##  fmarounded (x, y, z, inf); # == 7
