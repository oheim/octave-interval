...
unwind_protect
    ...
    arrayfun (@(x, y, z) plot3 (x, y, z, 'marker', '.', 'color', edgecolor), ...
    ...
    plot3 (x_line, y_line, z_line, 'linewidth', 2, 'color', edgecolor);
    ...
    [A, B, C, D, E, F, G, H] = num2cell ((0 : 7) * numel (boxes)) {:};
    ...
    if (nargin >= 5)
        ...
        if (not (isempty (xy_rect)))
            plot3 (vertices ([A E G C A] + xy_rect, 1), ...
                   vertices ([A E G C A] + xy_rect, 2), ...
                   vertices ([A E G C A] + xy_rect, 3), ...
        ...
        if (not (isempty (yz_rect)))
            plot3 (vertices ([A C D B A] + yz_rect, 1), ...
                   vertices ([A C D B A] + yz_rect, 2), ...
                   vertices ([A C D B A] + yz_rect, 3), ...
                   'color', edgecolor, 'linewidth', 2);
        endif
        ...
        if (not (isempty (xz_rect)))
            plot3 (vertices ([A E F B A] + xz_rect, 1), ...
                   vertices ([A E F B A] + xz_rect, 2), ...
                   vertices ([A E F B A] + xz_rect, 3), ...
                   'color', edgecolor, 'linewidth', 2);
        endif
        ...
        if (not (isempty (cuboids)))
            plot3 (vertices ([A B D C A E F B] + cuboids, 1), ...
                   vertices ([A B D C A E F B] + cuboids, 2), ...
                   vertices ([A B D C A E F B] + cuboids, 3), ...
                   'color', edgecolor, 'linewidth', 2);
            plot3 (vertices ([H G C D H F E G] + cuboids, 1), ...
                   vertices ([H G C D H F E G] + cuboids, 2), ...
                   vertices ([H G C D H F E G] + cuboids, 3), ...
                   'color', edgecolor, 'linewidth', 2);
        endif
    endif
