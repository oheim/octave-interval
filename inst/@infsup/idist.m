...
## @deftypefn {Function File} {} idist (@var{X}, @var{Y})
## 
...
## between each pair of numbers.  That is, the inner distance equals zero if
...
## @example
## @group
## idist (infsup (0, 6), infsup (7, 20))
##   @result{} ans =  1
## @end group
## @end example
## @seealso{@@infsup/sdist, @@infsup/hdist}
## @end deftypefn
