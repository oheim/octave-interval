...
%!test "minimal_is_common_dec_test";
%! assert (eq (...
...
%!test "minimal_is_singleton_test";
%! assert (eq (...
...
%!test "minimal_is_singleton_dec_test";
%! assert (eq (...
...
%!test "minimal_is_member_dec_test";
%! assert (eq (...
