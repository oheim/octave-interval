...
%!    true)))
%! assert (all (eq (...
%!    iscommoninterval (infsup (-1.797693134862315708e+308, 1.797693134862315708e+308)), ...
%!    true)))
%! assert (all (eq (...
...
%!    true)))
%! assert (all (eq (...
%!    iscommoninterval (infsupdec (-1.797693134862315708e+308, 1.797693134862315708e+308, "com")), ...
%!    true)))
%! assert (all (eq (...
...
%!    true)))
%! assert (all (eq (...
%!    iscommoninterval (infsupdec (-1.797693134862315708e+308, 1.797693134862315708e+308, "trv")), ...
%!    true)))
%! assert (all (eq (...
...
%!    false)))
%! assert (all (eq (...
%!    issingleton (infsup (-inf, -1.797693134862315708e+308)), ...
%!    false)))
%! assert (all (eq (...
...
%!    false)))
%! assert (all (eq (...
%!    issingleton (infsupdec (-inf, -1.797693134862315708e+308, "dac")), ...
%!    false)))
%! assert (all (eq (...
